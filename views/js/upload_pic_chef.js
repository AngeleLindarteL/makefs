...
const updatePhotoContainer = document.querySelector("#cambiarFoto-chef");
const notification_msg = document.querySelector("#notification-msg");
const userImg = document.querySelector(".profile-pic-img");
const userImgChef = document.querySelector(".profile-pic-img-chef");
