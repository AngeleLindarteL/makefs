...
<head>
    ...
    <link href="views/css/DarkLogin.css" rel="stylesheet">
    ...
    ?>
    <?php include("views/components/tokenControl.php") ?>
</head>
<body class="White">
    <header id="header">
        <div class="logocont">
        ...
        <div class="formcont">
            <div class="info-form">
                <form action="controllers/loginC.php" method="POST" class="form-done">
                    ...
                    <h4 class="aregister Whiteform"><p>No tienes una cuenta?</p><span><a href="/register"> Registrate!</a></span></h4>
